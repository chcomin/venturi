...
from torchtrainer.engine import test_util
from torchtrainer.engine.train_util import ParseKwargs, WrapDict, dict_to_argv, seed_all
...
def test(param_dict=None):
    ...
    if dataset_class=="oxford_pets":
        ...
        from torchtrainer.data.vessel import get_dataset_drive_test
