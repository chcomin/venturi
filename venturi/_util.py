...
class PlottingCallback(Callback):
    ...
    def on_train_epoch_end(self, trainer, pl_module):
        ...
        try:
            ...
            has_line = False
            for key in args_p.metrics: # type: ignore
                key_p = key
                if key_p == "train/loss":
...
class ImageSaveCallback(Callback):
    ...
    def _log_to_wandb(self, trainer, idx, img, target, pred):
        ...
        if class_labels is not None:
            ...
            masks["predictions"]["class_labels"] = class_labels
            masks["ground_truth"]["class_labels"] = class_labels
...
def get_next_experiment_name(run_path: Path) -> Path:
    """If 'run_path' exists, appends _2, _3, etc. until a free name is found."""
